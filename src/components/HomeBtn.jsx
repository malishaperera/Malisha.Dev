...
const HomeBtn = () => {
  return (
      <NavLink
          ...
          href={"/"}
          target={"_self"}
          className="text-foreground rounded-full flex items-center justify-center custom-bg fixed top-4 left-4 w-fit self-start z-50 hover:text-[#40b6f0]  hover:shadow-lg"
          aria-label={"home"}
          name={"home"}
          prefetch={false}
      >
