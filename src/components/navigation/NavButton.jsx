        ...
        {({ size }) => {
          return size && size >= 480 ? (
            ...
            >
              ...
              className="text-foreground rounded-full flex items-center justify-center custom-bg hover:text-[#40b6f0]  hover:border-[#40b6f0] hover:shadow-lg"
                aria-label={label}
                name={label}
              >
                {/*<span className="relative w-14 h-14 p-4 animate-spin-slow-reverse group-hover:pause hover:text-accent">*/}
                <span className="relative w-14 h-14 p-4 animate-spin-slow-reverse group-hover:pause hover:text-[#40b6f0]">
